...
public class 贪心_回溯 {
     ...
     */
    private void backTrack(List<Integer> path, List<List<Integer>> res, int step) {
    ...
    public List<List<Integer>> subsets(int[] nums) {
        ...
        // 调用回溯函数开始生成所有子集
        backTrack02(0, stack, 0, ans, nums);
        // 返回所有子集的结果
        return ans;
    }
    ...
    // 新添加的参数：
    // start ， 搜索的起始位置，  一个堆栈
    private void backTrack02(int start, Deque<Integer> stack,
    ...
    // depth 当前深度
    // res 结果的hold
    private void dfs(int[] candidates, int depth, int target,
